...
- 共生体：基础种族、组织剥离、玩家级子代池、十三张池内/衍生随从及其首批能力已经接入；从池中取得卡牌、共生体组织进化、附着到人类随从后入场以及纳尔的后期全局强化仍属于后续机制设计。
