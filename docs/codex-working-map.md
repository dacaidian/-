...
- 影月议会材质主体必须是黑紫膜包裹的黏稠压力核心，传输会鼓胀与收束，恶魔裂隙有内陷空间膜，疯狂广播是掠过棋盘的低矮压力前沿；灵魂使用蓝紫流体，诅咒与低语使用暗红紫。酸绿直线、空心圆和全卡绿色闪烁只允许作次级读数，不能重新承担法术主体。持续状态仍由 `CardStatusOverlay` 消费真实状态并保持低频呼吸，不能为了增强表现重复触发规则或叠加疯狂。
