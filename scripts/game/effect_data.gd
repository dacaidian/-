...
const KEY_ATTACK_OVERRIDE := "attack_override"
const KEY_ATTACK_SPEED_BONUS := "attack_speed_bonus"
const KEY_NEXT_ATTACK_BONUS_DAMAGE := "next_attack_bonus_damage"
const KEY_NEXT_ATTACK_HEAL := "next_attack_heal"
const KEY_NEXT_ATTACK_EXCLUDES_BUILDINGS := "next_attack_excludes_buildings"
...
const KEY_TICK_ANIMATION := "tick_animation"
const KEY_STATUS_COMPRESSED := "status_compressed"
const KEY_EXPIRE_ANIMATION := "expire_animation"
const KEY_DEATH_ON_EXPIRE_ANIMATION := "death_on_expire_animation"
...
const KEY_PERSISTENT_ANIMATION := "persistent_animation"
...
const KEY_DEATH_SLOT_REPLACEMENT := "death_slot_replacement"
const KEY_SLOT_OWNER := "slot_owner"
const KEY_OWNER_ID := "owner_id"
const KEY_VICTIM_LAYER := "victim_layer"
const KEY_DESTINATION_LAYER := "destination_layer"
...
const EFFECT_GAIN_PERMANENT_ATTACK := "gain_permanent_attack"
const EFFECT_UPDATE_SYMBIOTE_OFFSPRING_POOL := "update_symbiote_offspring_pool"
const EFFECT_RANDOM_NORMAL_ATTACKS := "random_normal_attacks"
const EFFECT_SYMBIOTE_WHIP := "symbiote_whip"
const EFFECT_SYMBIOTE_ABSORB := "symbiote_absorb"
const EFFECT_CARNAGE_KILL_PROGRESS := "carnage_kill_progress"
const EFFECT_ATTACH_SYMBIOTE_OFFSPRING := "attach_symbiote_offspring"
const EFFECT_TERRIFYING_SCREAM := "terrifying_scream"
const EFFECT_LIBERATE_CARD := "liberate_card"
...
const EFFECT_RESTORE_TRANSFORM := "restore_transform"
...
const TARGET_SOURCE_AREA_ENEMY_MINIONS := "source_area_enemy_minions"
...
const TARGET_ALL_MINIONS := "all_minions"

const DEATH_SLOT_OWNER_SOURCE := "source_owner"
const DEATH_SLOT_OWNER_DEFEATED := "defeated_owner"
const BOARD_LAYER_GROUND := "ground"
const BOARD_LAYER_AERIAL := "aerial"
