...
const UNIT_TRAIT_HUMANOID := "humanoid"
const UNIT_TRAIT_HUMAN := "human"
const UNIT_TRAIT_ELF := "elf"
const UNIT_TRAIT_ORC := "orc"
const UNIT_TRAIT_DWARF := "dwarf"
const UNIT_TRAIT_BEASTFOLK := "beastfolk"
const UNIT_TRAIT_GHOUL := "ghoul"
const UNIT_TRAIT_DEMON := "demon"
const UNIT_TRAIT_UNDEAD := "undead"
const UNIT_TRAIT_BEAST := "beast"
const UNIT_TRAIT_AVIAN := "avian"
const UNIT_TRAIT_REPTILE := "reptile"
const UNIT_TRAIT_INSECT := "insect"
const UNIT_TRAIT_ELEMENTAL := "elemental"
const UNIT_TRAIT_MECHANICAL := "mechanical"
const UNIT_TRAIT_CONSTRUCT := "construct"
const UNIT_TRAIT_SPIRIT := "spirit"
const UNIT_TRAIT_YAOGUAI := "yaoguai"
const UNIT_TRAIT_ALIEN := "alien"
const UNIT_TRAIT_ABERRATION := "aberration"
const UNIT_TRAIT_COSMIC := "cosmic"
const UNIT_TRAIT_GU := "gu"
const UNIT_TRAIT_FOX := "fox"
const UNIT_TRAIT_MONKEY := "monkey"
const UNIT_TRAIT_CHAOS := "chaos"
...
const KEYWORD_SILENCE_AURA := "silence_aura"
