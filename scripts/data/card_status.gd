...
const STATUS_EXTREME_COLD_STORM := "extreme_cold_storm"
const STATUS_EXTREME_COLD_STORM_FIRST_WAVE := "extreme_cold_storm_first_wave"
const STATUS_SOUL_HOOK := "soul_hook"
const STATUS_CHARM := "charm"
const STATUS_FIERY_EYES_VISION := "fiery_eyes_vision"
...
const STATUS_FEL_MADNESS_WARLOCK := "fel_madness_warlock"
...
const STATUS_SYMBIOTE_ABSORPTION := "symbiote_absorption"
