...
- **共生体**：当前包含 `2/20` 英雄毒液、共生神盾局探员、生物研究员、异噬体和基因战士。毒液可通过“自我剥离”，研究员可通过“人工剥离”使毒液攻击力永久 +1、受到2点伤害并获得无效果衍生法术“共生体组织”；两个动作分别使用活体组织分裂与实验室牵引封存的专属动态特效。后续将围绕有限子代池、宿主附着、子代进化与纳尔解放展开。
