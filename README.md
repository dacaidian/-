...
- **表现层**：包含卡牌动画、全战场触发特效、持续状态覆盖、数值图标、装备面板、种族面板、暗夜时间面板、背景音乐和音效门面。
...
- **影月议会**：古尔丹、灵魂虹吸、邪能灌注、邪能狂乱、混乱兽人、地狱犬、术士、基尔加丹的低语、混乱狼骑兵、末日守卫、魅魔与古尔丹之杖；以邪能标签触发本回合疯狂状态，装备可升级施法动作并引发邪能过载，术士诅咒引入可复用的伤害加深状态，基尔加丹的低语提供周期性邪能低语光环，黑暗之门体系待后续扩展。
