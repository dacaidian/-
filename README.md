...
- **东京喰种**：RC 细胞浓度会按本回合杀戮结果在低/中/高之间变化；施法回合在该种族中表现为“赫子解放”，四类赫子通过动态状态提供移动攻击、攻击/吸血、护甲/反伤或羽针副动作。金木研拥有尾赫法术和三种覆盖形态；SSS 阶喰种情报可提供芳村功善、高槻泉与旧多二福，包含赫者化、全体恢复、RC 提升、正面五格攻击和双重免疫等能力。S 阶与 SSS 阶喰种情报作为两套独立的有限随从库持续提供稀有单位。
