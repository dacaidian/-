...
- **共生体**：毒液和生物研究员可通过组织剥离使毒液攻击力永久 +1、受到2点伤害并获得“共生体组织”，每次剥离还会推进玩家级子代池。子代池初始包含暴乱、嚎叫、皮鞭、极端、吞噬、反毒液和共生体战士；嚎叫死亡会解锁沉默，五种基础子代均死亡会解锁混种，累计五次剥离会解锁毒素、屠杀和眠者。沉默光环、随机普通攻击、分支鞭打、吞噬继承和击杀成长均已接入；从子代池取得卡牌、宿主附着和纳尔体系仍待后续实现。
