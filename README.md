...
- **共生体**：毒液和生物研究员可通过组织剥离使毒液攻击力永久 +1、受到2点伤害并获得“共生体组织”，每次剥离还会推进玩家级子代池。组织可以附着于共生神盾局探员、生物研究员或基因战士，将宿主永久进化为随机可用子代；共生体战士放回池中，其余子代不放回。嚎叫死亡会解锁沉默，五种基础子代均死亡会解锁混种，累计五次剥离会解锁毒素、屠杀和眠者。沉默光环、随机普通攻击、分支鞭打、吞噬继承和击杀成长均已接入；更复杂的宿主能力与纳尔体系仍待后续实现。
